...
{
    public GameObject charmPaper;
    public GameObject charmPaperComeOut;
    ...
    private void SummoningCharmPaper()
    {
        Instantiate(charmPaper, transform.position, transform.rotation);

        if(!GameManagement.isPerformance)
        {
            GameObject particleEffect = Instantiate(charmPaperComeOut, transform.position, transform.rotation);
        }
    ...
    public override void die()
    {
        ...
        if (headTransform != null)
        {
            ...
            {
                // 实例化粒子效果
                GameObject particleEffect = Instantiate(zombieHeadDrops, headTransform.position, headTransform.rotation);
            }
        ...
        {
            Debug.LogWarning("Zombie_head not found.");
        }
